...
<!-- Page Title -->
<title>School Calender  - Sant Nischal Singh Public School, Ladwa</title>
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">School Calender </h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="home">Home</a></li>
                   <li><a href="#">Academics</a></li>
              
                <li class="active">School Calender </li>
              </ol>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container mt-30 mb-30 pt-30 pb-30">
        <div class="row">
                       <h2 class="text-uppercasetext-theme-colored mt-0 mb-0 mt-sm-30 text-center"> <span class="text-theme-colored2">School Calender </span> </h2>
