    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Manage Circulars</h2>
     ...
     <section>
      <div class="container pt-20 pb-20">
        <h2 class="heading-border text-center">Manage Circulars</h2>
        <div class="esc-heading lr-line left-heading pb-20">
          <!--<h4 class="text-center">All Classes I - X</h4>-->
        </div>
        <p class="text-center">  <code>Upload </code>and <code>Delete</code>Circulars...</p>
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <ul id="myTab" class="nav nav-tabs boot-tabs">
                <li class="active"><a href="#upload" data-toggle="tab">Upload Files</a></li>
                <li><a href="#delete" data-toggle="tab">Delete Files</a></li>
        ...
        <div class="row">
          <div class="col-md-6 col-md-push-3">
            <div class="border-1px p-30 mb-0">
              ...
              <form   action="dbfiles/dbadmin-circulars" method="post" enctype="multipart/form-data">
                  ...
                  <input name="circularimg" class="file" type="file" multiple data-show-upload="false" data-show-caption="true">
                  <small>Maximum upload file size: less than (<) 2MB </small><br> <small> Dimension For Image: 1653(w) X 2338(h)</small>
                </div>
                  </div>
            ...
            while($row=mysqli_fetch_array($res))
            {
              ...
              $pdfimg="uploadfiles/circulars/circular-image-for-pdf-file-upload111.jpg";
                ...
                ?>
                        ...
                        <img src='<?php  $info = pathinfo($img); if($info["extension"] == "pdf"){ echo $pdfimg;} else { echo $img;} ?>' class='img-fullwidth' style='width:250px;height:400px;' alt=''>  
                       
                        <?php
                        echo" <a href='dbfiles/dbdelete-records-circulars?id=$idd' type='submit' name='submit' class='btn btn-block btn-dark btn-theme-colored btn-sm mt-20 pt-10 pb-10' data-loading-text='Please wait...'> Delete</a>";
                  echo"</div>";
