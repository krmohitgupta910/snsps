...
<!-- Page Title -->
<title>Admin Panel - Fee Details  - Sant Nischal Singh Public School, Ladwa</title>
    ...
    <section>
      <div class="container-fluid">
              ...
              <div data-example-id="simple-responsive-table" class="bs-example"> 
                  ...
                  <div class="table-responsive">
                      <table class="table table-bordered table-hover"> 
                          <thead> <tr  style="background-color:#1592b4;color:white;"> <th>Class</th> <th>Tuition Fee</th><th>Action</th> </tr>  </thead> 
                          <!--<th>Misc Charges</th> <th>Computer Fee</th> <th>S/C Prac. Fee</th><th>Sports Fee</th><th>Annual Ch.</th>-->
                          <tbody>
                                          <?php
        ...
        $res=mysqli_query($db->conn,"select * from fee_details");
            ...
            {
                 echo"  <form action='dbfiles/dbadmin-fee-details' method='POST'> 
                                                <tr>
                                          
                                                <th scope='row'> $row[1] </th>
                                                <td><input type='text' name='col1' class='form-control' value='$row[2]'><input type='hidden'  name='idd' value='$row[0]'>  </td> 
         ...
         mysqli_close($db->conn);
                 ?> 
                               <!--<td>  <input type='text'  name='col6' value='$row[3]'></td>-->
