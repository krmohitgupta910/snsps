...
<!-- Page Title -->
<title>Admin Panel -TC Format - Sant Nischal Singh Public School, Ladwa</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Manage TC Format</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="#">Home</a></li>
           
                <li class="active">TC Format</li>
              </ol>
            </div>
          </div>
        </div>
     ...
     <section>
      <div class="container pt-20 pb-20">
        <h2 class="heading-border text-center">Manage TC Format</h2>
        <div class="esc-heading lr-line left-heading pb-20">
          <!--<h4 class="text-center">All Classes I - X</h4>-->
        </div>
        <p class="text-center">  <code>Upload </code>and <code>Delete</code>TC Format...</p>
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-md-6 col-md-push-3">
            <div class="border-1px p-30 mb-0">
              ...
              <form   action="dbfiles/dbadmin-tc.php" method="post" enctype="multipart/form-data">
               <!--<div class="row">-->
               <!--   <div class="col-sm-6">-->
               ...
               <!-- </div>-->
                  ...
                  <input name="tcformat" class="file" type="file" multiple data-show-upload="false" data-show-caption="true">
            ...
            while($row=mysqli_fetch_array($res))
            {
              ...
              $fil="uploadfiles/tc/".$row[1];
                echo"<div class='col-sm-2 col-md-4'>";
                        ...
                        echo" <a href='dbfiles/dbdelete-records-tc.php?id=$idd' type='submit' name='submit' class='btn btn-block btn-dark btn-theme-colored btn-sm mt-20 pt-10 pb-10' data-loading-text='Please wait...'> Delete</a>";
                  echo"</div>";
