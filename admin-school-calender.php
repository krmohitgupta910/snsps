...
<!-- Page Title -->
<title>Admin Panel - school-calendar - Sant Nischal Singh Public School, Ladwa</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Manage School Calendar</h2>
     ...
     <section>
      <div class="container pt-20 pb-20">
        <h2 class="heading-border text-center">Manage School Calendar</h2>
        <div class="esc-heading lr-line left-heading pb-20">
          <!--<h4 class="text-center">All Classes I - X</h4>-->
        </div>
        <p class="text-center">  <code>Upload </code>and <code>Delete</code> School Calendar...</p>
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-md-6 col-md-push-3">
            <div class="border-1px p-30 mb-0">
              ...
              <form   action="dbfiles/dbadmin-school-calendar" method="post" enctype="multipart/form-data">
              <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label>Title <small>*</small></label>
                      <input name="title" type="text" placeholder="Enter Title like.. School Calender 2018-19"  required="" class="form-control">
                    </div>
                  </div>
                  ...
                  <input name="calendar" class="file" type="file" multiple data-show-upload="false" data-show-caption="true">
        ...
        <div class="row">
          <div class="col-md-12 ">
           ...
           include_once 'dbfiles/db.php';
            $db=new db();
          $db->connect();
        $res=mysqli_query($db->conn,"select * from school_calendr");
         
            while($row=mysqli_fetch_array($res))
            {
                $idd=$row[0];
                $nam=$row[1];
              $fil="uploadfiles/school-calendar/".$row[2];
                echo"<div class='col-sm-2 col-md-4'>";
                        echo"<h5 class='text-center'>$nam </h5> ";   
                        echo" <a href='dbfiles/dbdelete-records-school-calendar?id=$idd' type='submit' name='submit' class='btn btn-block btn-dark btn-theme-colored btn-sm mt-20 pt-10 pb-10' data-loading-text='Please wait...'> Delete</a>";
                  echo"</div>";
