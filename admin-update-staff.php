      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12 mt-40">
            <hr>
            <h3 class="title text-center">Edit School Staff Records </h3>
              <div data-example-id="simple-responsive-table" class="bs-example"> 
                  
                  <div class="table-responsive">
                      <table class="table table-bordered table-hover"> 
                          <thead> <tr  style="background-color:#1592b4;color:white;"> <th>S No.</th> <th>Name</th> <th>Post</th> <th>TYPE OF TEACHER</th> <th>HIGHEST QUALIFICATION (ACADEMIC)</th> <th>HIGHEST QUALIFICATION (PROFESSIONAL)</th> <th>Action</th> </tr> </thead> 
                          <tbody>
                                          <?php
        ...
        $c=0;
            ...
            {   $c++;
                 echo"  <form action='dbfiles/dbadmin-update-staff' method='post'> 
                                                <tr>
                                                <th scope='row'> $c  </th>
                                             
                                                <td><input type='text' name='col1' value='$row[1]'>  </td> 
                                                <td><input type='text'  name='col2' value='$row[2]'> </td>   
                                                <td> <input type='text'  name='col3' value='$row[3]'>
                                                <input type='hidden'  name='idd' value='$row[0]'> </td>    
                                                <td>  <input type='text'  name='col4' value='$row[4]'></td>
                                               <td>  <input type='text'  name='col5' value='$row[5]'></td>
