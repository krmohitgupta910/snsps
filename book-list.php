...
<!-- Page Title -->
<title>Book List - Sant Nischal Singh Public School, Ladwa</title>
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-36">Book List</h2>
    ...
    <section>
      <div class="container mt-30 mb-30 pt-30 pb-30">
        <div class="row">
                       <h2 class="text-uppercasetext-theme-colored mt-0 mb-0 mt-sm-30 text-center">Book <span class="text-theme-colored2"> List</span> </h2>
              ...
              <article class="post clearfix mb-0">
                <div class="entry-header">                  
                  ...
                  echo"<h4 class='text-center'>$nam </h4> "."<br>"; 
                        echo"<h6 class='text-center' > <a href='$fil'  download style='color:#1592b4;'>Download </a></h6> "; 
