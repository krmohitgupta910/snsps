...
<!-- Page Title -->
<title>School Managing Committee - Sant Nischal Singh Public School, Ladwa</title>
    ...
    <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-theme-colored2 font-32">School Managing Committee</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="#">Home</a></li>
                 <li><a href="#">About SNSPS</a></li>
                <li class="active">School Managing Committee</li>
              </ol>
            </div>
          </div>
        </div>
